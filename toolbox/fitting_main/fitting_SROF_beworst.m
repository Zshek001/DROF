function [Zamide_DZ_vec_bes, Zguan_DZ_vec_bes, fit_para_bes, fit_para_wor] = fitting_SROF_beworst(offs, zspec_vec, FitParam, multistart_N)
...
%       amplitude unit: Hz
    ...
    for i = 1:Npixel
        ...
        problem = createOptimProblem('lsqcurvefit','x0',iv,'objective',R1rho_ss,...
