% display GE result of MTR,LDA,MPLF,MPLF_ss (single slice)
%   20241028
% clear; clc
% close all; 
addpath ..\toolbox
...
%% load data
filepath = uigetdir(".\20250203-fittingresult","select CEST fitting results folder");
filenameList = ["output_DZ_MTR.mat","output_DZ_LDA.mat","output_CO_MPLF.mat","output_R1rho_DROF.mat"];
% store variables:
%   pools_CO_map
%   pools_DZ_map
%   fit_para
...
exportgraphics(Fig1, OutputDir+"fig5.png", 'BackgroundColor', 'white', 'Resolution', resol);
