function y = lorentzMultipool_R1rho(p, x, FitParam)
...
pn = (length(p)-1)/3;
R1rho = p(1); % theoretically being R1w
...
y = (cos2thet - cos2thet*FitParam.R1./R1rho).* exp(-R1rho * FitParam.tsat) + cos2thet * FitParam.R1./R1rho;
